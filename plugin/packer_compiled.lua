...
_G.packer_plugins = {
  ...
  ["conform.nvim"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/conform.nvim",
  ...
  ["fortune.nvim"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/fortune.nvim",
  ...
  ["mason-tool-installer.nvim"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/mason-tool-installer.nvim",
  ...
  ["nvim-dap-vscode-js"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/nvim-dap-vscode-js",
